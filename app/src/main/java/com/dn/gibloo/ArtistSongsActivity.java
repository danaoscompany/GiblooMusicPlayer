...
public class ArtistSongsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artistId = getIntent().getLongExtra("artist_id", 0L);
        setTitle(artistName);
        ...
        new AsyncTask<String, Void, String>() {
            ...
            public void onPostExecute(String result) {
                ...
                adapter = new ArtistSongsAdapter(ArtistSongsActivity.this, songs);
                songList.setLayoutManager(new LinearLayoutManager(ArtistSongsActivity.this));
    ...
    public void collectSongs() {
        ...
        Cursor c = getContentResolver().query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, projections, MediaStore.Audio.Media.ARTIST_ID+"=?", new String[] {Long.toString(artistId)}, MediaStore.Audio.Media.TITLE+" ASC");
